...
void main() 
{	
	vec2 texCoords = vec2(floor(gl_FragCoord.x / resolution.x * MetaImage_MosaicNumber) / MetaImage_MosaicNumber, floor(gl_FragCoord.y / resolution.y * MetaImage_MosaicNumber) / MetaImage_MosaicNumber);
